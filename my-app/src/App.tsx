      ...
      <ul className="p-10  w-20  flex flex-col gap-8">
        <li className="w-20 hover:bg-gray-600">
          <button
            className=""
            onClick={() =>
              BioData.isBioOpen ? BioData.setIsBioOpen(false) : BioData.setIsBioOpen(true)
            }
          >
        ...
        <li className="w-16 hover:bg-gray-600">
          <button onClick={() => ResumeData.isResumeOpen ? ResumeData.setIsResumeOpen(false): ResumeData.setIsResumeOpen(true)}>
            <img className="ml-3 w-[30px] h-[30px]" src={ResumeIcon} alt="Resume" />
